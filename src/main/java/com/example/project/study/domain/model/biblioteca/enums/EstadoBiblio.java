...
public enum EstadoBiblio {
    ...
    public static EstadoBiblio from(String value) {
        if (value == null || value.isBlank()) {
            throw new ConditionFailedException("Estado não cadastrado, entrar em contato com a Administração");
        }
        ...
        if (sigla == null) {
            throw new ConditionFailedException("Estado inválido: " + value);
        }
